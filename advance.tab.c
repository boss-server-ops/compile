...
#line 44 "advance.y"
                          { printf("%f\n", yyvsp[-1]); }
#line 1154 "advance.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 49 "advance.y"
                          { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1160 "advance.tab.c"
    break;

  case 6: /* expr: expr SUB expr  */
#line 50 "advance.y"
                          { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1166 "advance.tab.c"
    break;

  case 7: /* expr: expr MUL expr  */
#line 51 "advance.y"
                          { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1172 "advance.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 52 "advance.y"
                          { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1178 "advance.tab.c"
    break;

  case 9: /* expr: LEFT_PAR expr RIGHT_PAR  */
#line 53 "advance.y"
                                     { yyval = yyvsp[-1]; }
#line 1184 "advance.tab.c"
    break;

  case 10: /* expr: SUB expr  */
#line 54 "advance.y"
                                  { yyval =-yyvsp[0]; }
#line 1190 "advance.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 55 "advance.y"
                  { yyval = yyvsp[0]; }
#line 1196 "advance.tab.c"
    break;


#line 1200 "advance.tab.c"
